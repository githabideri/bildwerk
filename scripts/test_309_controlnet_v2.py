#!/usr/bin/env python3
"""Test single ControlNet workflow on 309.jpg - Fixed version"""
...
async def main():
    # Load workflow
    workflow = json.load(open("/var/lib/clawdbot/workspace/agents/hgg16/bildwerk/workflows/309_controlnet_minimal_v2.json"))
